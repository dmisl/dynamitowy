<template>
    <table class="table table-primary table-bordered">
        <tbody>
            ...
            <tr>
                <td> Kamil Balda </td>
                <td class="text-center table-success"><svg xmlns="http://www.w3.org/2000/svg"
            ...
            <td class="text-center"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    version="1.1" width="10" height="10" viewBox="0 0 256 256" xml:space="preserve">
                    <defs></defs>
                    <g transform="translate(1.4065934065934016 1.4065934065934016) scale(2.81 2.81)"
                        style="stroke: none; stroke-width: 0; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 10; fill: none; fill-rule: nonzero; opacity: 1;">
                        <path
...
export default {
    ...
    mounted() {
        this.emmiter.on("ChangeTableData", (data) => {
