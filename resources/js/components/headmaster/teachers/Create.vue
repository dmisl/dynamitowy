<script setup>
    ...
    const newTeacher = ref({name: '', email: ''})
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mt-2">
                            ...
                            <label for="teacher" class="form-label fs-5 m-0 p-0">Imie Nazwisko</label>
                            <input v-model="newTeacher.name" class="form-control form-control-sm">

                            <label for="teacher" class="form-label fs-5 m-0 p-0 mt-1">Email</label>
                            <input v-model="newTeacher.email" class="form-control form-control-sm">

                            <div class="text-center mt-4">
                                <button @click="createTeacher" class="btn btn-primary" :disabled="!newTeacher.name || !newTeacher.email">Stwórz</button>
                            </div>
