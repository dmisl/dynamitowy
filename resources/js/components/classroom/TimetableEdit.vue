<script setup>
    ...
    function containsValuesForKeys(obj, key1, value1, key2, value2) {
        for (const prop in obj) {
            if (typeof obj[prop] === 'object') {
                if (containsValuesForKeys(obj[prop], key1, value1, key2, value2)) {
                    return true;
                }
...
<template>
    <div>
        ...
        <div v-else class="p-3">
            <a role="button" @click="change(imported.rawTimetable)" class="d-flex mb-2">
            ...
            <div class="d-flex flex-wrap">
                <div class="ms-5 col-md-3" v-for="(day, day_nr) in classroomLessons">
                    <div class="mt-3">
                        <h4 style="display: inline-block;">{{ days[day_nr] }}</h4>
