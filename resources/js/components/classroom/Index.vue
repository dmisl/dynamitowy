<script setup>
    ...
    onMounted(async () => {
        try {
            const usersResponse = await axios.get(`${props.pre}api/classroomUsers/${props.classroom_id}`);
            ...
            <table class="table table-light">
                <tbody>
                    ...
                    <tr v-for="(user, index) in users" :key="index">
                        <td>
                            <p class="m-0 p-0 small">{{ user.name }}</p>
                        </td>
                        <td>
                            <p class="m-0 p-0 small">{{ user.email }}</p>
                        </td>
                        <td>
                            <p class="m-0 p-0 small">{{ classroom.name }}</p>
                        </td>
                        <td>
                            <div class="d-flex">
